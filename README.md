...
- You can use testnet faucets (e.g.: [Etherlink faucet](https://faucet.etherlink.com/)) in order to obtain funds for usage with a testnet of your choice (e.g.: [Etherlink testnet](https://testnet.explorer.etherlink.com/)).
...
**Note:** If you would like to connect to a private or local blockchain network (e.g., the local Hardhat network), you may need to update the configuration provided below to allow the DCAP.Web service to connect to it. On some Linux distributions, when using local networks like Hardhat, you may need to use the `host` Docker network mode for the DCAP.Web container (see below).
...
Alternatively, you may update the DCAP.Web service to use the `host` network mode as shown below. This may be necessary to connect to local networks (e.g. Hardhat Network) on some Linux distributions.
...
+   -e DCAP__BlockchainUrl=http://localhost:8545/ \
```
...
You may also launch the service using the following Docker command:
...
Alternatively, you may set the container to use the `host` network mode with the following command:
...
```json
{
   "id": "urn:tar:eip155.128123:073d7a18417bc1feb1c88a342f7e26e6a62745ec",
   "receipt": "a781c353-de57-4171-85ca-5afd51ad610f",
   "data": {
      "@context": {
         "@version": 1.1,
         "foaf": "http://xmlns.com/foaf/0.1/",
   ...
   "checksum": "0x233C42EFBDDA44718E1594E0819A67D15F6A3319C1EDC2E92D2DBA0241A78050",
   "version": 1,
   "_sdHashes": null
}
```
...
Second, the DCAP profile asset schema needs to be uploaded in DCAP.Web which has as follows:
...
```json
{
   ...
   "receipt": "4d28dbce-f863-4605-a617-bf9e0754faae",
   "data": {
      "@context": [
         "urn:tar:eip155.128123:073d7a18417bc1feb1c88a342f7e26e6a62745ec",
         {
   ...
   "checksum": "0x56B360152924C6B45400A7C47A701B8BFBF6B0F3F1A5A534EFE8BF4C1EADBCDA",
   "version": 1,
   "_sdHashes": null
}
```
...
```json
{
   "id": "urn:tar:eip155.128123:e52af626d8e4c7b7fbd10e4f4865d6b3470f48ab",
   "receipt": "5eea38b8-2571-42b5-9340-9c4da4376cae",
   "data": {
      "@context": "urn:tar:eip155.128123:79db37caec7648cfc77cfa0a38876d2db7aaa6e1",
      "@type": [
         "dcap:CulturalHeritageObject",
   ...
   "checksum": "0x16994CF0B54ED8E20C71B80EF527DC8C03D7D2754230D2C3F83322FDB13E0D83",
   "version": 1,
   "_sdHashes": null
}
```

The id of the generated TAR (in this example, `urn:tar:eip155.128123:e52af626d8e4c7b7fbd10e4f4865d6b3470f48ab`) is the ID of the DCAP that you can later see at the [compellio/dcap-asset-explorer](https://github.com/compellio/dcap-asset-explorer)
